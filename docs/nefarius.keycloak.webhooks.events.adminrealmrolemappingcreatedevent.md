...
Inheritance [Object](https://learn.microsoft.com/dotnet/api/system.object) → [WebhookBaseEvent](./nefarius.keycloak.webhooks.events.webhookbaseevent.md) → [AdminWebhookEvent](./nefarius.keycloak.webhooks.events.adminwebhookevent.md) → [AdminRealmRoleMappingCreatedEvent](./nefarius.keycloak.webhooks.events.adminrealmrolemappingcreatedevent.md)
