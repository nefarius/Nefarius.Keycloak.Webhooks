...
Inheritance [Object](https://learn.microsoft.com/dotnet/api/system.object) → [WebhookSendSummary](./nefarius.keycloak.webhooks.client.models.webhooksendsummary.md) → [WebhookSendDetail](./nefarius.keycloak.webhooks.client.models.webhooksenddetail.md)<br>
...
### <a id="properties-payload"/>**Payload**
...
### <a id="constructors-.ctor"/>**WebhookSendDetail()**

```csharp
public WebhookSendDetail()
```
