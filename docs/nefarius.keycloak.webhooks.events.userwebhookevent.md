...
Any native Keycloak user event. Its [WebhookBaseEvent.Type](./nefarius.keycloak.webhooks.events.webhookbaseevent.md#type) starts with
 `access.`.
...
Inheritance [Object](https://learn.microsoft.com/dotnet/api/system.object) → [WebhookBaseEvent](./nefarius.keycloak.webhooks.events.webhookbaseevent.md) → [UserWebhookEvent](./nefarius.keycloak.webhooks.events.userwebhookevent.md)<br>
...
### <a id="constructors-.ctor"/>**UserWebhookEvent()**
