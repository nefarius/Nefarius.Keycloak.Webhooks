# AdminRealmRoleMappingDeletedEvent

Namespace: Nefarius.Keycloak.Webhooks.Events

A realm role has been removed from a user (`admin.REALM_ROLE_MAPPING-DELETE`).
...
### <a id="constructors-.ctor"/>**AdminRealmRoleMappingDeletedEvent()**

```csharp
public AdminRealmRoleMappingDeletedEvent()
```
